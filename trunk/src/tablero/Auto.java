...
public class Auto extends Thread {
	...
	/**
	 * Este metodo retorna un booleano que indica si esta la coordenada
	...
	/**
	 * Este metodo representa que el auto esta chocado, poniendo su
	 * variable "chocado" en true.
	 */
	public void chocar()
	{
		this.chocado=true;
	...
	/**
	 * Este metodo representa la reparacion de un auto que fue chocado, 
	 * poniendo su variable "chocado" en false.
	 */
	public void reparar()
	{
		this.chocado=false;
	...
	/**
	 * Este metodo cambia la direccion actual del coche por la
	 * Direccion d pasada por parametro.
	 * @param Direccion d
	 */
